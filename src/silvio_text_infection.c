...
size_t find_ret2textsection_offset(t_woody *woody)
{
    for (size_t i = 0; i < woody->payload_size; i++)
    {
...
size_t find_settextsectionsize_offset(t_woody *woody)
{
    for (size_t i = 0; i < woody->payload_size; i++)
    {
...
{
    size_t ret2textsection_offset = find_ret2textsection_offset(woody);
...
{
    size_t settextsectionsize_offset = find_settextsectionsize_offset(woody);
...
void get_payload(t_woody *woody)
{
