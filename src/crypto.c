...
void cipher_woody_file_data(t_woody *woody)
{
    ...
    // printf("\n");
    // printf("C XOR CIPHER\n");
    woody->cipher = rc4_cipher(woody, woody->mmap_ptr + woody->elf64_ptrs->text_start_offset, text_len);
    ...
    // void *crypt;
    // void *decrypt;
    // crypt = asmxorcipher(woody->mmap_ptr + woody->elf64_ptrs->text_start_offset, woody->encryption_key, text_len, strlen(woody->encryption_key));
